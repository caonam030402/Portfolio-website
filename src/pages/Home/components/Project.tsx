  ...
  return (
    <div className='container my-[25px] text-center'>
      ...
      <div className='mt-8 flex justify-center gap-5'>
        <button className='w-[100px] rounded-lg bg-blue-700 py-1'>All</button>
        <button className='w-[100px] rounded-lg border-[1px] border-blue-700 py-1'>Design</button>
        <button className='w-[100px] rounded-lg border-[1px] border-blue-700 py-1'>Web</button>
      </div>
